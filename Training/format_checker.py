...
def read_classes(file_path):
  ...
  #with open("B:/Documents/Cours/MSTelecom/Airbus Disinfo/SemEval 2021 - Task 6 - Detection of Persuasion Techniques in Texts and Images/AIMH/MemePersuasionDetection/"+file_path, 'r', encoding='utf8') as f:
